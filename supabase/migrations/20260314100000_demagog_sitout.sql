-- Players with >= 3 placements in a round sit out remaining sub-rounds.
-- Sub-rounds where no player has workers left are skipped.
-- This handles demagog lock-in carry-forward gracefully.
