-- Remove the demagogery_overview wait gate.
-- When all placements are done, go straight to demagogery_resolved.
-- The overview screen becomes a client-side overlay that doesn't block the game.

-- 1. Update submit_placement to skip demagogery_overview
...
BEGIN
  ...
  -- All done — go straight to demagogery_resolved (skip overview gate)
