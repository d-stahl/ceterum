-- Fix: demagog carry-forward was copying ALL demagog placements (including
-- already-locked ones from prior rounds). Only fresh (non-locked) placements
-- should be carried forward — locked demagogs have already served their extra
-- round and should expire.
