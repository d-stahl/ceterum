-- Snapshot post-demagogery influence for Endeavour threshold calculation.
-- The previous approach snapshotted influence at round creation (pre-demagogery),
-- which gave absurdly low thresholds since players start rounds near 0.
-- The correct base is post-demagogery influence — what players actually have to spend.
