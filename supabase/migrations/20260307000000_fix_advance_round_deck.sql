-- Fix advance_round: the idempotent rewrite in 20260306100000 accidentally
-- broke deck drawing by referencing games.deck_order (non-existent column)
-- and game_controversy_state for leftovers (wrong table).
-- Restore correct logic from 20260303000000 while keeping the idempotency fix.
