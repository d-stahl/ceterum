-- Remove affinity decay from advance_round.
-- Affinity is now only changed by promoters, saboteurs, and controversy resolutions
-- (which can now be both positive and negative based on faction stance).
