// Deno-compatible copy — keep in sync with mobile/lib/game-engine/demagogery.ts
...
export type WorkerEffect = {
  ...
  totalInfluence: number;    // final rounded payout (0 for promoter/saboteur)
  totalPowerChange: number;  // 0 for orators, +1/-1 for promoter/saboteur
};
